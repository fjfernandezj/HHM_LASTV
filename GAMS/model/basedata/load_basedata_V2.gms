...
execute_load "..\results\HouseholdChile_db_0208.gdx" p_householdData p_houGdsData p_consumptionData p_supplyData  ;
...
exinc('H2') = 0.2 * [[sum((c,a,s), p_householdData('H2',c,a,s,'srev'))/sum((c,a,s), 1$p_householdData('H2',c,a,s,'srev'))] *(1/1000000)] ;
exinc('H3') = 0.5 * [[sum((c,a,s), p_householdData('H3',c,a,s,'srev'))/sum((c,a,s), 1$p_householdData('H3',c,a,s,'srev'))] *(1/1000000)] ;
exinc('H4') = 0.8 * [[sum((c,a,s), p_householdData('H4',c,a,s,'srev'))/sum((c,a,s), 1$p_householdData('H4',c,a,s,'srev'))] *(1/1000000)] ;
*exinc('H5') = 0.5 * [[sum((c,a,s), p_householdData('H5',c,a,s,'srev'))/sum((c,a,s), 1$p_householdData('H5',c,a,s,'srev'))] *(1/1000000)] ;
...
fir(h,'oat','irr')=fir(h,'wht','irr');
fir(h,'ric','irr')=fir(h,'mze','irr')*(1.45);
hd = 0.6 ;
